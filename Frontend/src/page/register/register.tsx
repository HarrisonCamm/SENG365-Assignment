...
const RegisterPageContent: React.FunctionComponent = observer(() => {
...
const ProfileImageSelectorAndPreview: React.FunctionComponent<ProfileImageSelectorAndPreviewProps> = observer(({store}) => {
