...
export const ProfilePictureEditor: React.FunctionComponent = observer(() => {
...
const ProfilePictureEditorSkeleton: React.FunctionComponent = observer(() => {
  const store = useProfileStore()
...
const ProfilePictureEditorContent: React.FunctionComponent = observer(() => {
  const store = useProfileStore()
  const user = store.user as CurrentUserStore
