...
class ProfileDetailsEditorStore {
  ...
  readonly firstName: InputValue
  readonly lastName: InputValue
  readonly email: InputValue
  ...
  constructor(userId: number, firstName: string, lastName: string, email: string) {
    ...
    this.firstName = new InputValue<string>(firstName, notEmptyFieldValidator)
    this.lastName = new InputValue<string>(lastName, notEmptyFieldValidator)
    this.email = new InputValue<string>(email, emailFieldValidator)
  }
...
export const ProfileDetailsEditor: React.FunctionComponent = observer(() => {
...
const ProfileDetailsEditorSkeleton: React.FunctionComponent = () => {
  return (
...
const ProfileDetailsEditorContent: React.FunctionComponent = observer(() => {
