...
class PasswordEditorPopupStore {
  ...
  readonly currentPassword = new InputValue<string>("", notEmptyFieldValidator)
  readonly newPassword = new InputValue<string>("", passwordFieldValidator)
...
export const PasswordEditorPopup: React.FunctionComponent<PasswordEditorPopupProps> = observer(({ open, onClose }) => {
