...
export const OtherUserProfilePage: React.FunctionComponent = () => {
...
export const ProfilePage: React.FunctionComponent<ProfilePageProps> = observer(({user}) => {
...
const TitleWithActionButtons: React.FunctionComponent = observer(() => {
